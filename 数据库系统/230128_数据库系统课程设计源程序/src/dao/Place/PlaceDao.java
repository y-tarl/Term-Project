...
public interface PlaceDao extends Dao {
    public ArrayList<CoursesPlace> SelectCoursesPlace(String Cname,String Clname,String year) throws DaoException;//课程排名
    public ArrayList<String> SelectCoursesScoreDistribution(String Cname, String year) throws DaoException;//课程分数分布

    public ArrayList<ClassesPlace> SelectClassesPlace(String Cname,String Clname, String year) throws DaoException;//班级排名
    public ArrayList<MajorPlace> SelectMajorPlace(String Cname,String Clname, String year) throws DaoException;//专业排名
