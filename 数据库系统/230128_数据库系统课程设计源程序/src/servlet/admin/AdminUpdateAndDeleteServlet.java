            ...
            try {
                ...
                switch (pageName) {
                    case "Majors": {
                        ...
                        new AdminDaoImpl().UpdateMajors(hjy_Mname230128,hjy_Mno230128 );
                    }
                    break;
                    case "Classes": {
                        ...
                        new AdminDaoImpl().UpdateClasses( hjy_Clname230128, hjy_Mno230128,hjy_Clno230128);
                    }
                    break;
                    case "Teachers": {
                        ...
                        new AdminDaoImpl().UpdateTeachers( hjy_Tname230128, hjy_Tsex230128, hjy_Tage230128
                                , hjy_Tphone230128, hjy_Tprof230128, hjy_Tpassword230128,hjy_Tno230128);
                    }
                    break;
                    case "Students": {
                        ...
                        new AdminDaoImpl().UpdateStudents( hjy_Sname230128, hjy_Ssex230128, hjy_Sage230128, hjy_Scredits230128,
                                hjy_Slocation230128, hjy_Spassword230128, hjy_Clno230128, hjy_Sscore230128,hjy_Sno230128);
                    }
                    break;
                    case "Courses": {
                        ...
                        new AdminDaoImpl().UpdateCourses( hjy_Cname230128,
                                hjy_Ccredit230128, hjy_Cevaluation230128, hjy_Cterm230128, hjy_Cperiod230128,hjy_Cno230128, hjy_Clno230128);
                    }
                    break;
                    case "Province": {
                        ...
                        new AdminDaoImpl().UpdateProvince( hjy_Pname230128,hjy_Pno230128);
                    }
                    break;
                    case "City": {
                        ...
                        new AdminDaoImpl().UpdateCity( hjy_Ciname230128, hjy_Pno230128,hjy_Cino230128);
                    }
                    break;
                    case "District": {
                        ...
                        new AdminDaoImpl().UpdateDistrict( hjy_Dname230128, hjy_Cino230128,hjy_Dno230128);
                    }
                    break;
                }
            ...
            try {
                ...
                switch (pageName) {
                    case "Majors": {
                        String hjy_Mno230128 = request.getParameter("hjy_MnoMajors230128");
                        String hjy_Mname230128 = request.getParameter("hjy_MnameMajors230128");
                        new AdminDaoImpl().DeleteMajors( hjy_Mno230128);
                    }
                    break;
                    case "Classes": {
                        String hjy_Clno230128 = request.getParameter("hjy_Clnoclasses230128");
                        String hjy_Clname230128 = request.getParameter("hjy_Clnameclasses230128");
                        String hjy_Mno230128 = request.getParameter("hjy_Mnoclasses230128");
                        new AdminDaoImpl().DeleteClasses( hjy_Clno230128);
                    }
                    break;
                    case "Teachers": {
                        String hjy_Tno230128 = request.getParameter("hjy_TnoTeachers230128");
                        ...
                        String hjy_Tprof230128 = request.getParameter("hjy_TprofTeachers230128");
                        String hjy_Tpassword230128 = request.getParameter("hjy_TpasswordTeachers230128");
                        new AdminDaoImpl().DeleteTeachers( hjy_Tno230128);
                    }
                    break;
                    case "Students": {
                        String hjy_Sno230128 = request.getParameter("hjy_SnoStudents230128");
                        ...
                        String hjy_Clno230128 = request.getParameter("hjy_ClnoStudents230128");
                        double hjy_Sscore230128 = Double.parseDouble(request.getParameter("hjy_SscoreStudents230128"));
                        new AdminDaoImpl().DeleteStudents( hjy_Sno230128);
                    }
                    break;
                    case "Courses": {
                        String hjy_Cno230128 = request.getParameter("hjy_CnoCourses230128");
                        ...
                        String hjy_Cterm230128 = request.getParameter("hjy_CtermCourses230128");
                        int hjy_Cperiod230128 = Integer.parseInt(request.getParameter("hjy_CperiodCourses230128"));
                        new AdminDaoImpl().DeleteCourses( hjy_Cno230128,  hjy_Clno230128);
                    }
                    break;
                    case "SC": {
                        ...
                        new AdminDaoImpl().DeleteSC( hjy_Sno230128,  hjy_Cno230128,  hjy_Clno230128,  hjy_SCyear230128);
                    }
                    break;
                    case "TC": {
                        ...
                        new AdminDaoImpl().DeleteTC( hjy_Tno230128,  hjy_Cno230128,  hjy_Clno230128,  hjy_TCyear230128);
                    }
                    break;
                    case "Province": {
                        String hjy_Pno230128 = request.getParameter("hjy_PnoProvince230128");
                        String hjy_Pname230128 = request.getParameter("hjy_PnameProvince230128");
                        new AdminDaoImpl().DeleteProvince(hjy_Pno230128);
                    }
                    break;
                    case "City": {
                        String hjy_Cino230128 = request.getParameter("hjy_CinoCity230128");
                        String hjy_Ciname230128 = request.getParameter("hjy_CinameCity230128");
                        String hjy_Pno230128 = request.getParameter("hjy_PnoCity230128");
                        new AdminDaoImpl().DeleteCity(hjy_Cino230128);
                    }
                    break;
                    case "District": {
                        String hjy_Dno230128 = request.getParameter("hjy_DnoDistrict230128");
                        String hjy_Dname230128 = request.getParameter("hjy_DnameDistrict230128");
                        String hjy_Cino230128 = request.getParameter("hjy_CinoDistrict230128");
                        new AdminDaoImpl().DeleteDistrict(hjy_Dno230128);
                    }
                    break;
                }
