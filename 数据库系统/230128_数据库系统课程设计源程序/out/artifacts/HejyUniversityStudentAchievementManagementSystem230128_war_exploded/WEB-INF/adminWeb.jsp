                ...
                <div class="sidebar-category sidebar-default"
                    ...
                    <div class="category-content" style=" background-color: rgb(234,245,254);">
                        <ul id="fruits-nav" class="nav flex-column">
                            <li class="nav-item">
                                <a href="Admin.do?pageName=adminMyPage" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 我的主页
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=Majors" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 专业表管理
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=Classes" id="fillTable_Button" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 班级表管理
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=Teachers" id="QRcode_Button1" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 教师表管理
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=Students" id="QRcode_Button2" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 学生表管理
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=Courses" id="QRcode_Button3" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 课程表管理
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=SC" id="QRcode_Button4" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 学生成绩表管理
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=TC" id="QRcode_Button5" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 教师任课管理
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=Province" id="QRcode_Button6" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 省表管理
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=City" id="QRcode_Button7" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 市表管理
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="Admin.do?pageName=District" id="QRcode_Button8" class="nav-link">
