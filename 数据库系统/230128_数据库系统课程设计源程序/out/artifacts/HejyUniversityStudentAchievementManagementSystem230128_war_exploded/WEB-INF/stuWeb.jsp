                ...
                <div class="sidebar-category sidebar-default"
                    ...
                    <div class="category-content" style=" background-color: rgb(234,245,254);">
                        <ul id="fruits-nav" class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a href="stuGrade.do" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 学生成绩查询
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="CoursesAndCredits.do" id="fillTable_Button" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 在修课程与学分统计
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="stuClassesCourses.do" id="QRcode_Button" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 班级课程开设查询
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="collapse navbar-collapse" id="navcol-2">
                                <ul class="nav navbar-nav ml-auto" id="desktop-toolbar">
                                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link"
                                            ...
                                            height="25px">&nbsp;${sessionScope.stuInfomation.sname}<i class="fa fa-chevron-down fa-fw"></i></a>
        ...
        <div class="container">
            ...
            <%
                ...
                switch(pageName)
                {
                    case "stuMyPage" :
            %>
                    <%@ include file="/WEB-INF/myPages/stuMyPage.jsp" %>
            <%
                    break;
                    case "stuGrade" :
            %>
                    <%@ include file="/WEB-INF/studentsPages/stuGrade.jsp" %>
            <%
                    break;
                    case "CoursesAndCredits" :
            %>
                    <%@ include file="/WEB-INF/studentsPages/stuCoursesAndCredits.jsp" %>
            <%
                        break;
                    case "stuClassesCourses" :
            %>
                    <%@ include file="/WEB-INF/studentsPages/stuClassesCourses.jsp" %>
            <%
                        break;
                }
            %>
