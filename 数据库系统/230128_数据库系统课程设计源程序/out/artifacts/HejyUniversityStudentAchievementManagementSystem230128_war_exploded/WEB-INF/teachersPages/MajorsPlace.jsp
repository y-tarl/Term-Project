...
<%
    ...
    ArrayList<String> teachersCourses_MajorsPlace =  (ArrayList<String>)request.getAttribute("teachersCourses_MajorsPlace");
%>
                    ...
                    <div class="col-md-6 text-nowrap">
                        <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                            ...
                            <label style="margin-right: 40px">课程
                                <select name="teachersClasses_Majors" class="form-control form-control-sm custom-select custom-select-sm">
                                    <option value="请选择" selected="selected">请选择</option>
                                    <% for(int i=0;i<teachersCourses_MajorsPlace.size();++i)
                                    { %>
                                    <option value="<%= teachersCourses_MajorsPlace.get(i)%>"><%= teachersCourses_MajorsPlace.get(i)%></option>
                                    <% }%>
                                </select>&nbsp;
                            </label>
                        </div>
