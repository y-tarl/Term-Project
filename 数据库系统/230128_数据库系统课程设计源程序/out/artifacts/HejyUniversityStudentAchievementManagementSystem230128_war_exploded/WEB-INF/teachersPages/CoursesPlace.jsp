...
<%
    ...
    ArrayList<String> teachersCoursesSU_CoursesPlace =  (ArrayList<String>)request.getAttribute("teachersCourses_CoursesPlace");
%>
...
<div class="container-fluid" id="table_class" style="margin-top: 20px" >
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="CoursesPlace.do" method="post">
                <div class="row">
                    <div class="col-md-6 text-nowrap">
                        <div id="dataTable_length1" class="dataTables_length" aria-controls="dataTable">
                            ...
                            <label style="margin-right: 40px">课程
                                <select name="teachersCourses_CoursesPlace" class="form-control form-control-sm custom-select custom-select-sm">
                                    <option value="请选择" selected="selected">请选择</option>
                                    <% for(int i=0;i<teachersCoursesSU_CoursesPlace.size();++i)
                                    { %>
                                    <option value="<%= teachersCoursesSU_CoursesPlace.get(i)%>"><%= teachersCoursesSU_CoursesPlace.get(i)%></option>
                                    <% }%>
                                </select>&nbsp;
                            </label>
                        </div>
            ...
            <div class="table-responsive table mt-2" id="dataTable5" role="grid" aria-describedby="dataTable_info">
                ...
                <div class="row">
                    <div class="text-nowrap" style="max-width: 100%;">
                        <form action="showDatasPage" method="post">
                            <div id="dataTable_length5" class="dataTables_length" aria-controls="dataTable">
                            </div>
            ...
            <div class="card-body">
                ...
                <script>
                    ...
                    option = {
                        ...
                        color:[ 'rgb(92,123,217)','rgb(115,192,222)','rgb(145,204,117)','rgb(250,200,88)','rgb(238,117,117)'],
                        series: [
                            {
                                name: '比例',
                                type: 'pie',
