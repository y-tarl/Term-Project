...
<%
    ...
    ArrayList<String> teachersCoursesSU_AvgScore =  (ArrayList<String>)request.getAttribute("teachersCourses_AvgScore");
%>
                    ...
                    <div class="col-md-6 text-nowrap">
                        <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                            ...
                            <label style="margin-right: 40px">课程
                                <select name="teachersClasses_AvgScore" class="form-control form-control-sm custom-select custom-select-sm">
                                    <option value="请选择" selected="selected">请选择</option>
                                    <% for(int i=0;i<teachersCoursesSU_AvgScore.size();++i)
                                    { %>
                                    <option value="<%= teachersCoursesSU_AvgScore.get(i)%>"><%= teachersCoursesSU_AvgScore.get(i)%></option>
                                    <% }%>
                                </select>&nbsp;
                            </label>
                        </div>
