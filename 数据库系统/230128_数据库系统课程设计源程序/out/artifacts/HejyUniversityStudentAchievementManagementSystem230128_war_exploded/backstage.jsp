...
<nav class="navbar navbar-light navbar-expand-md navigation-clean">
    <div class="container"><a class="navbar-brand" href="index.jsp">✒️ 正元教务管理系统<br></a>
...
<div class="register-photo" style="height: 643px;background-position: center;background-color: rgb(232,240,254);padding-top: 12px;padding-bottom: 69px;">
...
<div class="footer-basic" style="padding-top: 13px;height: 95px;">
    <footer style="height: 59px;">
        <p class="copyright" style="height: 37px;"><br>Powered by 何佳莹</p>
    </footer>
</div>
