...
<div class="container-fluid" id="myPage" style="margin-top: 20px;">
    ...
    <div class="row">
        <div class="col-md-6 col-xl-3 mb-4">
            <a href="stuGrade.do"  style="text-decoration: none;">
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <a href="CoursesAndCredits.do" id="QRcode_button" style="text-decoration: none;">
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <a href="stuClassesCourses.do" id="fillTable_button" style="text-decoration: none;">
                <div class="card shadow border-left-primary py-2">
                    <div class="card-body">
                        <div class="row align-items-center no-gutters">
                            <div class="col mr-2">
                                ...
                                <div class="text-dark font-weight-bold h5 mb-0"><span>查询班级信息</span></div>
                            </div>
                            <div class="col-auto"><i class="fas fa-calendar fa-2x text-gray-300"></i></div>
                        </div>
                    </div>
