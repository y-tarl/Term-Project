            ...
            <div id="sidebar-main" class="sidebar sidebar-default sidebar-separate"
                ...
                <div class="sidebar-category sidebar-default"
                    ...
                    <div class="category-title" style="height: 64px; background-color: rgb(234,245,254);">
                            <span
                                    style="color: black; font-size: 1.25rem; line-height: 40px; padding-top: 0">🎓正元教务管理系统</span>
                    </div>
                    <div class="category-content" style=" background-color: rgb(234,245,254);">
                        <ul id="fruits-nav" class="nav flex-column">
                            <li class="nav-item">
                                <a href="LogIn.do" id="myPage_Button" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="#other-fruits1" class="nav-link" data-toggle="collapse" role="button"
                                   aria-expanded="false" aria-controls="other-fruits1">
                                    <b class=" " aria-hidden="true">🔵</b> 学生排名查询
                                </a>
                                <ul id="other-fruits1" class="flex-column collapse">
                                    <li class="nav-item">
                                        <a href="CoursesPlace.do" id="table_college_Button" class="nav-link">
                                            <b class=" " aria-hidden="true">🔵</b> 课程排名概览
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ClassesPlace.do" id="table_major_Button" class="nav-link">
                                            <b class=" " aria-hidden="true">🔵</b> 班级排名概览
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="MajorsPlace.do" id="table_class_Button" class="nav-link">
                                            <b class=" " aria-hidden="true">🔵</b> 专业排名概览
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a href="AvgScoreCount.do" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 课程平均成绩查询
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="ScoreUpload.do" id="fillTable_Button" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 成绩录入
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="TeachersCourses.do" id="QRcode_Button" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 教师任课查询
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="StuLocation.do" id="QRcode_Button2" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 学生地区统计
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="collapse navbar-collapse" id="navcol-2">
                                <ul class="nav navbar-nav ml-auto" id="desktop-toolbar">
                                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link"
                                            ...
                                            height="25px">&nbsp;${sessionScope.teaInfomation.tname}<i class="fa fa-chevron-down fa-fw"></i></a>
                                        <div class="dropdown-menu" role="menu">
                                            <a class="dropdown-item" role="presentation" href="LogOut.do"><i
        ...
        <div class="container">
            ...
            <%
                ...
                switch(pageName)
                {
                    case "teaMyPage" :
            %>
            <%@ include file="/WEB-INF/myPages/teachersMyPage.jsp" %>
            <%
                    break;
                case "CoursesPlace" :
            %>
            <%@ include file="/WEB-INF/teachersPages/CoursesPlace.jsp" %>
            <%
                    break;
                case "MajorsPlace" :
            %>
            <%@ include file="/WEB-INF/teachersPages/MajorsPlace.jsp" %>
            <%
                    break;
                case "ClassesPlace" :
            %>
            <%@ include file="/WEB-INF/teachersPages/ClassesPlace.jsp" %>
            <%
                        break;
                case "AvgScoreCount" :
            %>
            <%@ include file="/WEB-INF/teachersPages/AvgScoreCount.jsp" %>
            <%
                        break;
                case "TeachersCourses" :
            %>
            <%@ include file="/WEB-INF/teachersPages/TeachersCourses.jsp" %>
            <%
                        break;
                case "ScoreUpload" :
            %>
            <%@ include file="/WEB-INF/teachersPages/ScoreUpload.jsp" %>
            <%
                        break;
                case "StuLocation" :
            %>
            <%@ include file="/WEB-INF/teachersPages/StuLocation.jsp" %>
            <%
                        break;
                }
            %>
