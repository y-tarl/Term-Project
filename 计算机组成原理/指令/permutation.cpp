...
int main() {
    ...
    MULTEND:
    R0 = R3;// MOV R0, R3 | R0=R3
    //$P 26 4C   ;1100 MOV R0, R3 | R0=R3
    R1 = P60H;// LAD R1, 60H | R1=m
    //$P 27 C1   ;0001  直接寻址 + E   LAD R1, 60H | R1=m
    //$P 28 60
    R2 = P61H;// LAD R2, 61H | R2=n-m
    //$P 29 C2  ; 0010  直接寻址 + E  LAD R2, 61H | R2=n-m
    //$P 2A 61
    R3 = P62H;// LAD R3, 62H | R3=i
    //$P 2B C3  ; 0011  直接寻址 + E  LAD R3, 62H | R3=i
    //$P 2C 62
    goto LOOP;// JMP LOOP
    //$P 2D E0  ;直接寻址+**+E JMP LOOP
    //$P 2E 0C

    RESULT:
    cout << R0 << endl;// OUT R0, 00H | 输出结果
    //$P 2F 30   ;0000 E+**  OUT R0, 40H | 输出结果
    //$P 30 40
    //$P 31 50    ;HLT
}