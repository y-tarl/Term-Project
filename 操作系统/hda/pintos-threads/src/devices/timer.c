...
#define TIMER_FREQ_MIN 19 /*range of TIME_FQER*/
#define TIMER_FREQ_MAX 1000

#if TIMER_FREQ < TIMER_FREQ_MIN
#error 8254 timer requires TIMER_FREQ >= TIMER_FREQ_MIN
#endif
#if TIMER_FREQ > TIMER_FREQ_MAX
#error TIMER_FREQ <= TIMER_FREQ_MAX recommended
#endif
...
/*Determine if there are too many cycles*/
static bool too_many_loops(unsigned loops);

/* Busy-wait specific time. */
